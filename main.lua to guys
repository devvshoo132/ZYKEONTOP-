-- Adonis Admin Bypass
pcall(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/FE/main/Bypasses/Adonis.lua"))()
end)

-- Load Rayfield UI (Fixed Rayfield link)
local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/shlexware/Rayfield/main/source.lua"))()

-- Create the Window
local Window = Rayfield:CreateWindow({
    Name = "ZYKE MAIN CHEAT",
    Icon = 0, -- You can replace 0 with a custom image ID if desired
    LoadingTitle = "Made by devvv",
    LoadingSubtitle = "by devvs",
    ConfigurationSaving = {
        Enabled = false,
        FolderName = nil,
        FileName = "ZYKE MAIN"
    ...
    Discord = {
        Enabled = true,
        Invite = "/j4zxsUtS", -- The Discord invite code
        RememberJoins = true
    },

    KeySystem = true,
    KeySettings = {
        Title = "ZYKE MAINCHEAT",
        Subtitle = "Key Required To Use",
        Note = "Join Discord: discord.gg/zyke",
        FileName = "ZYKE-KEY-FILE",
        SaveKey = true,
...
Rayfield:Notify({
   Title = "ZYKE MAIN",
   Content = "Thankyou For Using ZYKE MAIN  Script",
   Duration = 5,
   Image = nil,
})

local Button = MainTab:CreateButton({
   Name = "INFINITE YIELD [ZYKE]",
   Callback = function()
